...
Begin VB.Form frmExceptions 
   Caption         =   "Exceptions Results"
   ClientHeight    =   3300
   ClientLeft      =   9000
   ClientTop       =   7110
   ClientWidth     =   9945
   ...
   Begin VB.Frame fraEnabler 
      ...
      Begin VB.CommandButton cmdFile 
         ...
         Height          =   585
         Left            =   8910
         Picture         =   "frmExceptions.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   810
         Width           =   870
      ...
      Begin VB.CommandButton cmdPrint 
         ...
         Height          =   585
         Left            =   8910
         Picture         =   "frmExceptions.frx":0102
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   225
         Width           =   870
   ...
   End
End
Attribute VB_Name = "frmExceptions"
...
Sub ConfigureListView()
  ' actually the report will do this
...
Public Sub Fill()
  ...
  NewReport.Fill 0 ' dummy param for now
